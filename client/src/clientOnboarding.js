  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/clientuser`,
        { clientForm }
      );
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="experience">
              ...
              <input
                ...
                onChange={(e) =>
                  setClientForm({
                    ...clientForm,
                    client_experience: e.target.value,
                  })
                }
                checked={true}
              />
          ...
          <section className="section-third">
            ...
            <div className="pic-container">
              {clientForm.client_url && (
                <img
                  src={clientForm.client_url}
                  alt="Profile Picture"
